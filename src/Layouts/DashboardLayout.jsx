        ...
        <div className="flex min-h-full flex-col items-start bg-base-200 is-drawer-close:w-14 is-drawer-open:w-64">
          ...
          <ul className="menu w-full grow">
            ...
            {normalizedRole === 'student' && (
              <>
                <li>
                  <NavLink to="/dashboard/my_tuitions" className={sidebarClass} data-tip="My Tuitions">
                    <MdSwipeDownAlt />
            ...
            {normalizedRole === 'admin' && (
              <>
                <li>
                  <NavLink to="/dashboard/approve-tutors" className={sidebarClass} data-tip="Approve Tutors">
                    <RiUserAddFill />
                ...
                <li>
                  <NavLink to="/dashboard/approve-tuitions" className={sidebarClass} data-tip="Approve Tuitions">
                    <MdCheckCircle />
